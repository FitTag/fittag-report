...
Il dispositivo wearable è un'unità indipendente dotata di batteria, IMU (Inertial Measurement Unit) e sensore Pulse-Oximeter (sensore di battiti e di ossigenazione del sangue).
...
Questa capacità è resa possibile dall'implementazione a on-device di un modello di Machine Learning ottimizzato per l'inferenza in tempo reale.
