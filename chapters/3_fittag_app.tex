...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{img/app/home_screen.png}
    \caption{Schermata principale (Home Screen).}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{img/app/workout_screen.png}
    \caption{Schermata di allenamento attivo.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{img/app/workout_detail_screen.png}
    \caption{Schermata di dettaglio dell'allenamento.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{img/app/inference_screen.png}
    \caption{Schermata di inferenza dell'attività.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{img/app/settings_screen.png}
